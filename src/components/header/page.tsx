...
import { numenticaHeaderLogo, hamBurger, numenticaLogo, cross } from '@/utils/imageConstants';
...
const Header = ({ header }: HeaderDataType) => {
  ...
  return (
    <header className="bg-[#F6F6F6]">
      <div className="pl- m-auto flex max-w-350 items-center justify-between gap-4 pb-4 pt-4 lg:px-10 sm:px-2">
        <div className="flex w-full items-center gap-4 md:justify-between md:gap-1">
          ...
          <div className="relative">
            <div
              className="flex h-35px w-35px cursor-pointer items-center justify-center 4xl:hidden 3xl:hidden md:flex sm:h-[25px] sm:w-30px"
            ...
            <div
              className={`fixed inset-y-0 right-0 z-50 transform border-l  border-gray-200 bg-white transition-transform duration-500 md:w-50% sm:w-70% ${
            ...
            >
              <div className="flex flex-wrap justify-between text-nowrap  border-b border-solid p-4">
                <div className="flex h-10 w-10 items-center gap-2 xs:h-7 xs:w-7">
                  ...
                  <h5 className="font-normal xs:text-[16px]">
                    {/* numentica <strong>ui</strong> */}
                    {companyName}
                  </h5>
                </div>
        ...
        <nav className="flex items-center gap-10 font-primary md:hidden">
          {headerlinks?.map((links) => {
